...
// o tempo estimado de entrega de um restaurante. A mensagem deve conter o nome do restaurante
// e o tempo estimado de entrega em minutos.
...
// Saída:
// Deverá retornar uma mensagem (string) informando ao usuário o tempo estimado de entrega
// do restaurante. Por exemplo, para o restaurante Bar do Zinho com o tempo estimado de entrega sendo 20, imprima:
// O restaurante Bar do Zinho entrega em 20 minutos.

const prompt = require('prompt-sync')();

const nomeRestaurante = prompt();
const tempoEstimadoEntrega = parseInt(prompt());
